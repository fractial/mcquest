...
#Name
data modify storage quest:name Name set value ["Steve","Alex","Markus","Jens","Dinnerbone","Grumm","Jack","Dennis","Elric","Mira","Thomlin","Anwen","Brigg","Liora","Fen","Willa","Jorin","Sela","Tavik","Nella","Osric","Heddie","Rusk","Alwen","Garrik","Ysolde","Bram","Eira","Toril","Marn","Kelwin","Tansy","Hollis","Fendrel","Isla","Caddoc","Rhea","Orlen","Vika","Laz","Norra","Darik","Maela","Orren","Venn","Tilda","Rowan","Bett","Hale","Nico","Wren","Thora","Dagen","Frida","Soren","Leif","Nim","Edda","Halvar","Kira","Juna","Tobin","Varn","Reema","Quill","Sibyl","Dax","Olen","Cael","Minna","Grel","Tovi","Luma"]