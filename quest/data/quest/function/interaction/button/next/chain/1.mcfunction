...
data modify entity @s equipment.chest.components.minecraft:custom_data.QuestData.page set from storage quest:progress Progress.page

scoreboard players operation @s quest_progress_display = @s quest_progress
scoreboard players add @s quest_progress_display 1

function quest:interaction/chain/1